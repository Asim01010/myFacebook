...
const GetPosts = ({
  ...
  const showCaptionAbove =
    postImage || (isWhite(background.startColor) && !background.image);
  const showCaptionCentered =
    !postImage && (background.image || !isWhite(background.startColor));
